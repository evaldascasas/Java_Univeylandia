 ...
 * @author manel
 */
public class LlistarTaules extends javax.swing.JFrame {

    /**
     * Creates new form LlistarTaules
     */
    public LlistarTaules() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Llistar Taules");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LlistarTaules.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LlistarTaules().setVisible(true);
            }
        });
    }
